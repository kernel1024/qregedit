...
QString CRegController::getHivePrefix(struct hive *hdesc)
{
    ...
    switch (hdesc->type) {
        case HTYPE_SAM:
            ret = QString("HKEY_LOCAL_MACHINE\\SAM");
            break;

        case HTYPE_SYSTEM:
            ret = QString("HKEY_LOCAL_MACHINE\\SYSTEM");
            break;

        case HTYPE_SECURITY:
            ret = QString("HKEY_LOCAL_MACHINE\\SECURITY");
            break;

        case HTYPE_SOFTWARE:
            ret = QString("HKEY_LOCAL_MACHINE\\SOFTWARE");
            break;

        case HTYPE_USER:
            ret = QString("HKEY_CURRENT_USER");
            break;
...
QString CRegController::getOSInfo(struct hive *hdesc)
{
    ...
    QDateTime idate = QDateTime::fromSecsSinceEpoch(date.vDWORD);
